						...
						<div id="title" class="page-title">
							<div class="section-container">
								...
								<div class="breadcrumbs">
									<a href="index.html">Home</a><span class="delimiter"></span><a href="shop-grid-left.html">Shop</a><span class="delimiter"></span>Necklace
								</div>
							</div>
						</div>
													...
													<ul class="products-list">
														<li class="product-item">
															<a href="shop-details.html" class="product-image">
																<img src="{{asset('/assets/media/product/nk1.jpeg">
															</a>
