						...
						<div id="title" class="page-title">
							<div class="section-container">
								...
								<div class="breadcrumbs">
									<a href="index.html">Home</a><span class="delimiter"></span><a href="shop-grid-left.html">Shop</a><span class="delimiter"></span>Egitarring
								</div>
							</div>
						</div>
											...
											<div class="block block-product-filter clearfix">
												...
												<div class="block-content">
													<ul class="filter-items image">
														<li><a href="shop-grid-left.html"><span><img src="{{asset('/assets/media/brand/1.jpg')}}" alt="Brand"></span></a></li>
														<li><a href="shop-grid-left.html"><span><img src="{{asset('/assets/media/brand/2.jpg')}}" alt="Brand"></span></a></li>
														<li><a href="shop-grid-left.html"><span><img src="{{asset('/assets/media/brand/3.jpg')}}" alt="Brand"></span></a></li>
														<li><a href="shop-grid-left.html"><span><img src="{{asset('/assets/media/brand/4.jpg')}}" alt="Brand"></span></a></li>
														<li><a href="shop-grid-left.html"><span><img src="{{asset('/assets/media/brand/5.jpg')}}" alt="Brand"></span></a></li>
													</ul>
												</div>
											</div>
													...
													<ul class="products-list">
														<li class="product-item">
															<a href="shop-details.html" class="product-image">
																<img src="{{asset('/assetsmedia/product/1.jpg')}}">
															</a>
														...
														<li class="product-item">
															<a href="shop-details.html" class="product-image">
																<img src="{{asset('/assets/media/product/2.jpg')}}">
															</a>
															<div class="product-content">
																<h2 class="product-title">
																	<a href="shop-details.html">
														...
														<li class="product-item">
															<a href="shop-details.html" class="product-image">
																<img src="{{asset('/assets/media/product/3.jpg')}}">
															</a>
															<div class="product-content">
																<h2 class="product-title">
																	<a href="shop-details.html">
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/1.jpg')}}" class="post-image" alt="">
																				<img width="600" height="600" src="{{asset('/assets/media/product/1-2.jpg')}}" class="hover-image back" alt="">
																			</a>
																		</div>		
																...
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover border">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/5.jpg')}}" class="post-image" alt="">
															...
															<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/2.jpg')}}" class="post-image" alt="">
															...
															<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover border">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/6.jpg')}}" class="post-image" alt="">
															...
															<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/3.jpg')}}" class="post-image" alt="">
															...
															<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover border">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/7.jpg')}}" class="post-image" alt="">
															...
															<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		<div class="product-thumb-hover">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/4.jpg')}}" class="post-image" alt="">
															...
															<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover border">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/8.jpg')}}" class="post-image" alt="">
															...
															<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
																<div class="products-entry clearfix product-wapper">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover border">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/9.jpg')}}" class="post-image" alt="">
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/2.')}}" class="post-image" alt="">
																				<img width="600" height="600" src="{{asset('/assets/media/product/2-2.jpg')}}" class="hover-image back" alt="">
																			</a>
																		</div>
																		<span class="product-quickview" data-title="Quick View">
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover border">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/6.')}}" class="post-image" alt="">
																				<img width="600" height="600" src="{{asset('/assets/media/product/6-2.')}}" class="hover-image back" alt="">
																			</a>
																		</div>
																		<span class="product-quickview" data-title="Quick View">
																			<a href="#" class="quickview quickview-button">Quick View <i class="icon-search"></i></a>
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/3.')}}" class="post-image" alt="">
																				<img width="600" height="600" src="{{asset('/assets/media/product/3-2.')}}" class="hover-image back" alt="">
																			</a>
																		</div>
																		<span class="product-quickview" data-title="Quick View">
																			<a href="#" class="quickview quickview-button">Quick View <i class="icon-search"></i></a>
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover border">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/7.')}}" class="post-image" alt="">
																				<img width="600" height="600" src="{{asset('/assets/media/product/7-2.')}}" class="hover-image back" alt="">
																			</a>
																		</div>
																		<span class="product-quickview" data-title="Quick View">
																			<a href="#" class="quickview quickview-button">Quick View <i class="icon-search"></i></a>
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/4.')}}" class="post-image" alt="">
																				<img width="600" height="600" src="{{asset('/assets/media/product/4-2.')}}" class="hover-image back" alt="">
																			</a>
																		</div>
																		<span class="product-quickview" data-title="Quick View">
																			<a href="#" class="quickview quickview-button">Quick View <i class="icon-search"></i></a>
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover border">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/8.')}}" class="post-image" alt="">
																				<img width="600" height="600" src="{{asset('/assets/media/product/8-2.')}}" class="hover-image back" alt="">
																			</a>
																		</div>
																		<span class="product-quickview" data-title="Quick View">
																			<a href="#" class="quickview quickview-button">Quick View <i class="icon-search"></i></a>
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="products-thumb">
																		...
																		<div class="product-thumb-hover border">
																			<a href="shop-details.html">
																				<img width="600" height="600" src="{{asset('/assets/media/product/9.')}}" class="post-image" alt="">
																				<img width="600" height="600" src="{{asset('/assets/media/product/9-2.')}}" class="hover-image back" alt="">
																			</a>
																		</div>
																		<span class="product-quickview" data-title="Quick View">
																			<a href="#" class="quickview quickview-button">Quick View <i class="icon-search"></i></a>
