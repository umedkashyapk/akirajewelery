											...
											<nav id="main-navigation">
												<ul id="menu-main-menu" class="menu">
													...
													<li class="level-0 menu-item menu-item-has-children">
														<a href=""><span class="menu-item-text">Products</span></a>
														<ul class="sub-menu">
															<li >
															...
															<li >
																<a href="{{route('necklace')}}"><span class="menu-item-text">NECKLACE</span></a>
																
															</li>
															<li >
																<a href="{{route('bracelets')}}"><span class="menu-item-text">BRACELETS</span></a>
																
															</li>
															<li >
																<a href="{{route('earring')}}"><span class="menu-item-text">EARRINGS</span></a>
